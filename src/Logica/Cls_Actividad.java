...
public class Cls_Actividad {
    ...
    private final String SQL_SELECT = "SELECT *FROM `Actividad`, `Sensores` WHERE (`Actividad`.`sensor` = `Sensores`.id_sensor) AND `Actividad`.`sensor` IN ('1','2','11','4','5','6','7','8','9','10') ORDER BY `Actividad`.`hora` DESC LIMIT 1";
